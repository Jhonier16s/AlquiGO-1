...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    description: 'AirPods Pro con cancelación activa de ruido, audio espacial y hasta 30 horas de batería.',
    category: 'electrónicos',
    condition: 'new',
  ...
  },
  {
    ...
    description: 'iPhone 15 Pro Max con chip A17 Pro, sistema de cámara triple y Action Button.',
    category: 'electrónicos',
    condition: 'new',
  ...
  },
  {
    ...
    description: 'Licuadora profesional Vitamix con motor de 2.2 HP, perfecta para smoothies y sopas.',
    category: 'hogar',
    condition: 'good',
  ...
  },
  {
    ...
    description: 'Nike Air Max 270 para running y actividades deportivas. Tecnología Air visible.',
    category: 'ropa',
    condition: 'excellent',
  ...
  },
  {
    ...
    description: 'Trek X-Caliber 8 con cuadro de aluminio, suspensión RockShox y cambios Shimano.',
    category: 'deportes',
    condition: 'good',
